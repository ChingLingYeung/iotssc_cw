...
static M2MResource* m2m_accelX;
static M2MResource* m2m_accelY;
static M2MResource* m2m_accelZ;
static M2MResource* m2m_gyroX;
static M2MResource* m2m_gyroY;
static M2MResource* m2m_gyroZ;
...
void update_readings(){
      ...
      printf("GYRO_Y = %.2f\n", pGyroDataXYZ[1]);
      printf("GYRO_Z = %.2f\n", pGyroDataXYZ[2]);
      m2m_accelX->set_value(pAccelDataXYZ[0]);
      m2m_accelY->set_value(pAccelDataXYZ[1]);
      m2m_accelZ->set_value(pAccelDataXYZ[2]);
      m2m_gyroX->set_value(pGyroDataXYZ[0]);
      m2m_gyroY->set_value(pGyroDataXYZ[1]);
      m2m_gyroZ->set_value(pGyroDataXYZ[2]);
...
//https://www.openmobilealliance.org/wp/OMNA/LwM2M/LwM2MRegistry.html
    m2m_accelX = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5702, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
    m2m_accelY = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5703, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
    m2m_accelZ = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
    m2m_gyroX = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5702, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
    m2m_gyroY = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5703, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
    m2m_gyroZ = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
...
/* Your code here*/
   ...
   /* Your code here*/
    ...
    queue.call_every(200, update_readings);
